...
// WEBSSH_DIST_DIR lets the desktop shell (whose bundled single-file server has
// a different import.meta.url depth) point at the frontend explicitly.
export const DIST_DIR = process.env.WEBSSH_DIST_DIR || join(__dirname, '..', 'dist', 'client');
