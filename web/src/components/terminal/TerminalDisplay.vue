...
const darkTerminalTheme = {
  ...
  cursor: '#FFFFFF',
  cursorAccent: '#0a0a0a',
  selectionBackground: 'rgba(85,85,85,0.3)',
...
const lightTerminalTheme = {
  ...
  cursor: '#333333',
  cursorAccent: '#ffffff',
  selectionBackground: 'rgba(214,214,214,0.35)',
...
const terminalThemes = {
  'solarized-dark': {
    ...
    selectionBackground: 'rgba(7,54,66,0.3)', selectionForeground: '#ffffff', black: '#073642', red: '#dc322f', green: '#859900', yellow: '#b58900',
  ...
  'solarized-light': {
    ...
    selectionBackground: 'rgba(238,232,213,0.35)', selectionForeground: '#000000', black: '#073642', red: '#dc322f', green: '#859900', yellow: '#b58900',
    blue: '#268bd2', magenta: '#d33682', cyan: '#2aa198', white: '#eee8d5',
    brightBlack: '#002b36', brightRed: '#cb4b16', brightGreen: '#586e75', brightYellow: '#657b83',
    brightBlue: '#839496', brightMagenta: '#6c71c4', brightCyan: '#93a1a1', brightWhite: '#fdf6e3',
  },
  'dracula': {
    ...
    selectionBackground: 'rgba(68,71,90,0.3)', selectionForeground: '#ffffff', black: '#21222c', red: '#ff5555', green: '#50fa7b', yellow: '#f1fa8c',
  ...
  'monokai': {
    ...
    selectionBackground: 'rgba(73,72,62,0.3)', selectionForeground: '#ffffff', black: '#272822', red: '#f92672', green: '#a6e22e', yellow: '#f4bf75',
  ...
  'nord': {
    ...
    selectionBackground: 'rgba(67,76,94,0.3)', selectionForeground: '#ffffff', black: '#3b4252', red: '#bf616a', green: '#a3be8c', yellow: '#ebcb8b',
  ...
  'one-dark': {
    ...
    selectionBackground: 'rgba(62,68,82,0.3)', selectionForeground: '#ffffff', black: '#282c34', red: '#e06c75', green: '#98c379', yellow: '#d19a66',
