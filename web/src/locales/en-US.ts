export default {
  ...
  server: {
    ...
    exportPasswordWarning: 'The exported file will contain your server passwords in PLAINTEXT. Anyone with this file can access all your servers directly. Only share this file through secure channels.',
    exportWarningTitle: 'Security Warning',
    exportWithPassword: 'Export with passwords',
    exportWithoutPassword: 'Export without passwords',
